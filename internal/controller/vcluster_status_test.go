...
func TestBudgetRefusedMakesReadyFalseAndPhaseFailed(t *testing.T) {
	...
	vc := newObservedVCluster(t, ctx, "budget-refuse", nil)
	seedCondition(t, ctx, vc, v1alpha1.CondBudgetOK, metav1.ConditionFalse, "BudgetExceeded",
		"plafond CPU de la cell dépassé")
